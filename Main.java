...
class Main {
  public static void main(String[] args) {
    ...
    /**
     * Create a player and then get player's input which Pokemon they want at
     * starter pokemon. After that assign chosen pokemon to player.
     */
    Trainer player = null;
    ...
    while (player.getHp() > 0) {
      ...
      if (map.getCharAtLoc(player.getLocation()) == 'p') {
        ...
        switch (randPerson) {
          ...
          case 2:
            System.out.println(
                "You are ambushed. As you open your eyes, you see a Gastly flying away. Gastley AMBUSHED you for 3 damage.");
            player.takeDamage(3);
            break;
          case 3:
            System.out.println("You run into Misty.\nMisty: " + player.getName()
