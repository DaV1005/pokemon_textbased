...
public class PokemonGenerator {
  ...
  /**
  Creates a random pokemon by reading from the txt file
  */
...
//                Pokemon temp = addRandomBuff(poke);
  ...
  /**
  @param the name of the pokemon
  Decorates the pokemon according to their elemental type
  */
  ...
  /**
  @param the pokemon
  The pokemon receives a random buff
  */
  ...
  /**
  @param the pokemon
  The pokemon receives a random debuff
  */
